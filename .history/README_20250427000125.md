...
## Docker setup, EC2 Instance Setup and Kubernetes Cluster Deployment using Rancher with Jenkins CI/CD Pipeline
...
## 🚀 Production Deployment & Working Demo

After Docker/Kubernetes deployment, the Django app is running live on EC2!

### 1. API Endpoint (Production)
- **URL:** [http://18.210.92.130:31845/survey/1/](http://18.210.92.130:31845/survey/1/)
- **Description:** Example of retrieving a single survey as JSON from the production server.

![API Production Screenshot](./Images/api-prod.jpg)

---

### 2. User Interface (Production)
- **URL:** [http://18.210.92.130:31845/survey/list/](http://18.210.92.130:31845/survey/list/)
- **Description:** Live UI for survey listing, editing, and deletion on the production cluster.

![UI Production Screenshot](./Images/list-prod.jpg)
